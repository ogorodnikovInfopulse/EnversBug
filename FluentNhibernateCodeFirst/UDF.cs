...
namespace FluentNhibernateCodeFirst
{
    ...
    public class UDFDefNhibMap : ClassMapping<UDFDef>
    {
    ...
    public class EntityUDFNhibMap<TUDF, TTypeToExtend, TId> : ClassMapping<TUDF>
    ...
    public class SomeEntNhimMap : ClassMapping<SomeEntity>
    {
